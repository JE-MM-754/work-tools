...
const scenarios = [
  ...
  {
    title: 'Base plus Unsupervised retainer, 5 hrs/week',
    gross: '$451K gross household income',
    net: '$25.8K monthly take-home planning number',
    housing: '$5.25K housing',
    cars: '$1.4K total car payments',
    other: '$7K other life, debt, food, utilities, travel, misc',
    takeaway: '$12.15K/month left',
    delta: '+$8K to +$10K per month better than today',
  },
  {
    title: 'Base plus Unsupervised retainer, 10 hrs/week',
    gross: '$477K gross household income',
    net: '$27K monthly take-home planning number',
    housing: '$5.25K housing',
    cars: '$1.4K total car payments',
    other: '$7.25K other life, debt, food, utilities, travel, misc',
    takeaway: '$13.1K/month left',
    delta: '+$9K to +$11K per month better than today',
  },
  {
...
const strategicPlan = [
  ...
  'Use the Unsupervised retainer as additional short-term upside and extra cash generation while it remains available.',
